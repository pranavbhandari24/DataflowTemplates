...
public class DataGenerator {
  ...
  private DataGenerator(Builder builder) {
    ...
    this.dataGeneratorOptions = LaunchConfig.builder(builder.getJobName())
        .setSpecPath(SPEC_PATH)
        .setParameters(builder.getParameters())
        .build();
  }

  public static DataGenerator.Builder builder(String jobName) {
   ...
   *
   * Note: This is a blocking call. For backlog tests, start the Data generator before executing
  ...
  public void execute(Duration timeout) throws IOException {
    JobInfo dataGeneratorJobInfo =
        dataflowClient.launchTemplate(PROJECT, REGION, dataGeneratorOptions);
    ...
    if (dataGeneratorOptions.parameters().containsKey("messagesLimit")) {
      ...
      // STREAMING job, wait till timeout
      dataGeneratorResult = dataflowOperator.waitForConditionAndFinish(config, () -> false);
  ...
  public static final class Builder {
    ...
    public DataGenerator.Builder setMessagesLimit(String value) {
      parameters.put("messagesLimit", value);
      return this;
    }
    ...
    public DataGenerator.Builder setAutoscalingAlgorithm(String value) {
      parameters.put("autoscalingAlgorithm", value);
      return this;
    }
    ...
    public DataGenerator build() {
      checkArgument(parameters.get("schemaLocation") != null);
